...
function mapTestimoniRow(object $item, ?Request $request = null): array
{
    $isActive = (int) ($item->is_active ?? 1) === 1;
...
function testimoniTableMissingResponse()
{
    return response()->json([
...
Route::get('/admin/testimonials', function (Request $request) {
    if (!Schema::hasTable('tbl_testimoni')) {
        return testimoniTableMissingResponse();
    }
    ...
    $items = $query->get()->map(fn ($item) => mapTestimoniRow($item, $request));
...
Route::get('/admin/testimonials/{pid}', function (Request $request, $pid) {
    if (!Schema::hasTable('tbl_testimoni')) {
        return testimoniTableMissingResponse();
    }
    ...
    return response()->json([
        ...
        'data' => mapTestimoniRow($item, $request),
    ]);
});

Route::post('/admin/testimonials', function (Request $request) {
    if (!Schema::hasTable('tbl_testimoni')) {
        return testimoniTableMissingResponse();
    }
    ...
    return response()->json([
        ...
        'data' => mapTestimoniRow(DB::table('tbl_testimoni')->where('pid', $testimoniId)->first(), $request),
    ], 201);
});

Route::put('/admin/testimonials/{pid}', function (Request $request, $pid) {
    if (!Schema::hasTable('tbl_testimoni')) {
        return testimoniTableMissingResponse();
    }
    ...
    return response()->json([
        ...
        'data' => mapTestimoniRow(DB::table('tbl_testimoni')->where('pid', $pid)->first(), $request),
    ]);
});

Route::delete('/admin/testimonials/{pid}', function ($pid) {
    if (!Schema::hasTable('tbl_testimoni')) {
        return testimoniTableMissingResponse();
    }
...
Route::patch('/admin/testimonials/{pid}/restore', function (Request $request, $pid) {
    if (!Schema::hasTable('tbl_testimoni')) {
        return testimoniTableMissingResponse();
    }
...
Route::patch('/admin/testimonials/{pid}/toggle', function (Request $request, $pid) {
    if (!Schema::hasTable('tbl_testimoni')) {
        return testimoniTableMissingResponse();
    }
...
Route::get('/testimonials', function (Request $request) {
    if (!Schema::hasTable('tbl_testimoni')) {
        return response()->json([
    ...
    $testimonials = DB::table('tbl_testimoni')
        ...
        ->orderBy('pid')
        ->get()
        ->map(fn ($item) => mapTestimoniRow($item, $request));
